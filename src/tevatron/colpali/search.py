...
def main():
    ...
    parser.add_argument('--processor_name', default="vidore/colqwen2.5-v0.2")
    ...
    for reps, look_up in shards:
        ...
        scores = retriever.score_multi_vector(q_reps, reps) # (num_queries, num_passages)
    ...
    if args.save_text:
        write_ranking(psg_indices, all_scores, q_lookup, args.save_ranking_to, args.depth)
    else:
