...
BASE_MODEL_NAME_OR_PATH="Qwen/Qwen3-VL-Embedding-2B"
MODEL_NAME_OR_PATH="/home/thuy0050/mg61_scratch2/thuy0050/exp/vlmcl/qwen3vl_embedding_no_lora_attention_output_r=8_3epochs"
LORAS_NAME_OR_PATH="$MODEL_NAME_OR_PATH/checkpoint-933" # /lora_paths.txt
